...
RUN mkdir -p /godot/releases && mkdir -p /github/home/.local/share/godot/export_templates/4.2.1.stable/
WORKDIR /godot 
...
RUN unzip Godot_v4.2.1-stable_linux.x86_64.zip && unzip Godot_v4.2.1-stable_export_templates.tpz -d /github/home/.local/share/godot/
